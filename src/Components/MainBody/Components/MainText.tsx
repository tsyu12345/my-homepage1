...
export const MainText = () => {
    return (
        <div id="mainText">
            ...
            <p className="msg">大変申し訳ございませんが、ただいま当サイトはリニューアル工事に伴い、一時閉鎖させていただいております。</p>
            <p className="msg">工事の詳細について以下をお読みいただき、リニューアル後にまたお越しください。お待ちしております。</p>
            <div className="info-text-wrapper">
                <InfoText title="【予定工期】" text="2月 ～ 5月中旬頃まで。"></InfoText>
                <InfoText title="【工事内容】" text="使用技術の更新、サイト全体のリニューアル・軽量化、その他成果物展示を目的とした全面リフォーム。"></InfoText>
            </div>
